...
public:
    ...
    MOCK_METHOD(void, seek, (const muse::midi::tick_t), (override));
    MOCK_METHOD(void, seek, (const muse::audio::msecs_t), (override));
    ...
    MOCK_METHOD(async::Channel<muse::audio::TrackId>, trackAdded, (), (const, override));
    MOCK_METHOD(async::Channel<muse::audio::TrackId>, trackRemoved, (), (const, override));

    MOCK_METHOD(std::string, auxChannelName, (muse::audio::aux_channel_idx_t), (const, override));
    MOCK_METHOD((async::Channel<muse::audio::aux_channel_idx_t, std::string>), auxChannelNameChanged, (), (const, override));

    MOCK_METHOD(async::Promise<muse::audio::SoundPresetList>, availableSoundPresets, (const engraving::InstrumentTrackId&), (const,
                                                                                                                             override));
    ...
    MOCK_METHOD(void, playElements, (const std::vector<const notation::EngravingItem*>&, double gain), (override));
